...
module.exports = {
     ...
     */
    ownername: process.env.OWNER_NUMBER || process.env.Owner_Name || "DILU",
    ownernumber: process.env.Owner_Number || "776387351",
    ...
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/ImoNFznVZFR1qlFA9u0cpR",
    warns: Number(process.env.Warn_Limits) || 3,
    cooldown: Number(process.env.Cooldown_Timer_Seconds) || 5, // default cooldown time per command in seconds
    mongoUrl: process.env.MongoDB || "YOUR_MONGODB_URL",
    sessionId: process.env.SESSION_ID || "PW_A_N_Y_A_V_2_JdXOoAbEo7B0uk0s1H",
